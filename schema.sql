...
-- Más Entradas
('mandocas-queso',    'Mandocas con Queso',          'Anillos fritos de masa de maíz con plátano maduro, panela y especias, coronadas con queso blanco rallado. Porción de 5 unidades.', 6.0,  'entradas',    'salad',    'https://loremflickr.com/600/600/food,fried/all?lock=1', NULL, 'entradas', 1),
('arepitas-nata',     'Mini Arepitas con Nata',      'Arepitas fritas abombadas y crujientes, acompañadas de fresca nata criolla para untar. Porción de 10 unidades.', 5.5,  'entradas',    'salad',    'https://loremflickr.com/600/600/food,corn/all?lock=2', NULL, 'entradas', 1),
('patacones-carne',   'Patacones de Carne',          'Tostones de plátano verde crujiente cubiertos de carne mechada, queso rallado, lechuga y salsa rosada. Porción de 2 unidades.', 9.0,  'entradas',    'salad',    'https://loremflickr.com/600/600/food,plantain/all?lock=3', NULL, 'entradas', 1),
('tostones-playeros', 'Tostones Playeros',           'Rodajas gruesas de plátano verde frito, coronados con ensalada rallada, queso blanco y salsas típicas.', 7.0,  'entradas',    'salad',    'https://loremflickr.com/600/600/food,tostones/all?lock=4', NULL, 'entradas', 1),
-- Más Principales
('asado-negro',       'Asado Negro Caraqueño',       'Corte de muchacho redondo cocido a fuego lento en una rica salsa de papelón oscuro y vino. Servido con puré y arroz.', 16.0, 'principales', 'utensils', 'https://loremflickr.com/600/600/food,beef/all?lock=5', NULL, 'principales', 1),
('sopa-res',          'Sopa de Res Cruzado',         'Potente caldo de costilla de res con verduras surtidas (yuca, ñame, ocumo, auyama) y un toque de cilantro fresco.', 10.0, 'principales', 'utensils', 'https://loremflickr.com/600/600/food,soup/all?lock=6', NULL, 'principales', 1),
('cachapa-queso',     'Cachapa con Queso de Mano',   'Tortilla gruesa y dulce de maíz tierno, rellena generosamente de queso de mano derretido, bañada en mantequilla.', 11.0, 'principales', 'utensils', 'https://loremflickr.com/600/600/food,corn/all?lock=7', NULL, 'principales', 1),
('arepa-reina',       'Arepa Reina Pepiada',         'Nuestra famosa arepa asada rellena de una cremosa mezcla de pollo desmechado, aguacate y mayonesa. Un clásico.', 8.5, 'principales', 'utensils', 'https://loremflickr.com/600/600/food,avocado/all?lock=8', NULL, 'principales', 1),
('arepa-pelua',       'Arepa Pelúa',                 'Arepa asada rellena de jugosa carne mechada y abundante queso amarillo rallado.', 8.5, 'principales', 'utensils', 'https://loremflickr.com/600/600/food,meat/all?lock=9', NULL, 'principales', 1),
('hervido-gallina',   'Hervido de Gallina',          'Consomé tradicional de gallina con verduras enteras. Ideal para recargar energías, servido con arepitas.', 10.0, 'principales', 'utensils', 'https://loremflickr.com/600/600/food,chicken_soup/all?lock=10', NULL, 'principales', 1),
-- Más Combos
('combo-pareja',      'Combo Enamorados',            'Para dos: 1 Parrilla mixta mediana, 2 raciones de tequeños y 2 bebidas a elección.', 28.0, 'combos', 'package-2', 'https://loremflickr.com/600/600/food,grill/all?lock=11', NULL, 'combos', 1),
('combo-arepero',     'Mega Combo Arepero',          'Degustación de 4 arepas (Reina, Pelúa, Dominó, Sifrina) con una ración de nata extra y 4 bebidas.', 35.0, 'combos', 'package-2', 'https://loremflickr.com/600/600/food,bread/all?lock=12', NULL, 'combos', 1),
-- Más Postres
('marquesa-choco',    'Marquesa de Chocolate',       'Postre frío de capas de galleta María intercaladas con una suave y rica crema de chocolate.', 5.5, 'postres', 'cake', 'https://loremflickr.com/600/600/food,chocolate/all?lock=13', NULL, 'postres', 1),
